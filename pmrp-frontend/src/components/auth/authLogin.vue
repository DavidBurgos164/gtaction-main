        ...
        <div class="limiter" style="user-select: none;">
            <div class="container-login100" style="user-select: none;">
                <div class="wrap-login100">
                  <div class="headerSelect"><i class="fa-solid fa-shield-halved"></i>Autenticación<p style="margin-top:0.3vw">Logea en tu cuenta.</p></div>
                  ...
                  <form class="login100-form validate-form" id="auth-form" @submit.prevent="add()">
                        ...
                        <div  class="wrap-input100 validate-input" style="margin-bottom: 23px;">
                            <div class="label-input100" style="color: #fff;"><i class="fa-solid fa-user"></i> Usuario</div>
                            <input class="input100" id="loginName" type="text" placeholder="Introduce tu usuario" v-model="username">
                            <div class="focus-input100"></div>
                        </div>

                        <div class="wrap-input100 validate-input">
                            <div class="label-input100" style="color: #fff;"><i class="fa-solid fa-lock"></i> Contraseña</div>
                            <input id="loginPass" class="input100" type="password" placeholder="Introduce tu contraseña" v-model="password">
                            <div class="focus-input100"></div>
                        ...
                        <b><a @click="register()" style="color: rgb(209, 209, 209); text-decoration:none">¿No tienes cuenta? Registrate ahora now</a><br></b>

                        <p style="margin-top:0.4vw;">
                          <label for="loginAuto">Auto Login (No usar si compartes el pc) </label> <input name="loginAuto" type="checkbox" v-model="autoLogin"></p>
                        ...
                        <div class="container-login100-form-btn" style="margin-top: 1vw;">
                            <div class="wrap-login100-form-btn">
                                <div class="login100-form-bgbtn"></div>
                                <button type="submit" id="loginBtn" @click="copyURL()" class="login100-form-btn">Unete al discord</button>
                            </div>
                        </div>
                        <br>
                </form>
  ...
  methods: {
    login() {
      if (this.username.length == 0 || this.password.length == 0) {
        ...
        global.gui.notify.showNotification(
          "Asegúrese de que tanto el campo de nombre de usuario como el de contraseña estén completos y contengan las credenciales de cuenta correctas.",
          false,
          true,
          5000,
    ...
    async copyURL() {
      ...
      try {
        ...
        global.gui.notify.showNotification(
          "Copiado el enlace de invitación del servidor de Discord a su portapapeles",
          false,
          true,
          5000,
          "fa-solid fa-circle-info"
        ...
        console.log($e);
        global.gui.notify.showNotification(
          "Ha ocurrido un error copiando el link de discord. [ Error: " + $e + " ]",
          false,
          true,
          5000,
