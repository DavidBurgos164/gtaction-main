class seatBelts {
    ...
    beltOn() {
        ...
        if(mp.players.local.getVariable('adminDuty')) {
            mp.events.call('notifCreate', '~r~Se pone el cinturon')
            return
        }
        mp.events.call('ameCreate', 'Se pone el cinturon')
    }
    ...
    beltOff() {
        ...
        if(mp.players.local.getVariable('adminDuty')) {
            mp.events.call('notifCreate', '~r~Se quita el cinturon')
            return
        }
        mp.events.call('ameCreate', 'Se quita el cinturon')
    }
