...
let cablesDerecha = randomCables();
let cablesIzquierda = randomCables();
// 1 = azul, 2 = rojo, 3 = rosa, 4 = amarillo
let cablesColores = new Map()
cablesColores.set("azul",["m","n"])
cablesColores.set("rojo",["o","p"])
cablesColores.set("rosa",["s","t"])
cablesColores.set("amarillo",["q","r"])

cableNumeroIzquierda = revesCables(cablesIzquierda)
primerDragCorrecto = dragCorrecto(1,cablesIzquierda[0],cablesDerecha)
segundoDragCorrecto = dragCorrecto(2,cablesIzquierda[1],cablesDerecha)
terceroDragCorrecto = dragCorrecto(3,cablesIzquierda[2],cablesDerecha)
cuartoDragCorrecto = dragCorrecto(4,cablesIzquierda[3],cablesDerecha)


primeroDerecha = [cablesColores.get(cablesDerecha[0])[0],cablesColores.get(cablesDerecha[0])[1]]

segundoDerecha = [cablesColores.get(cablesDerecha[1])[0],cablesColores.get(cablesDerecha[1])[1]]  

terceroDerecha = [cablesColores.get(cablesDerecha[2])[0],cablesColores.get(cablesDerecha[2])[1]]

cuartoDerecha = [cablesColores.get(cablesDerecha[3])[0],cablesColores.get(cablesDerecha[3])[1]]  

primeroIzquierda = [cablesColores.get(cablesIzquierda[0])[0],cablesColores.get(cablesIzquierda[0])[1]]

segundoIzquierda = [cablesColores.get(cablesIzquierda[1])[0],cablesColores.get(cablesIzquierda[1])[1]]

terceroIzquierda = [cablesColores.get(cablesIzquierda[2])[0],cablesColores.get(cablesIzquierda[2])[1]]

cuartoIzquierda = [cablesColores.get(cablesIzquierda[3])[0],cablesColores.get(cablesIzquierda[3])[1]]


svg = document.getElementById("svg-id")

svg.innerHTML = `<linearGradient id="a" y1="453.5" x2="907" y2="453.5" gradientUnits="userSpaceOnUse">
...
<path class="${primeroIzquierda[0]}" d="M8.5 167.5h66v33h-66z"/> <!--m = azul oscuro-->
<path class="${primeroIzquierda[1]}" d="M8.5 176.5h66v17h-66z"/> <!--n = azul claro-->
<path class="l" d="M8.51 333.16H59.5v24.34H8.51z"/>
<path class="${segundoIzquierda[0]}" d="M8.5 357.5h66v33h-66z"/> <!--o = rojo oscuro-->
<path class="${segundoIzquierda[1]}" d="M8.5 366.5h66v17h-66z"/> <!--p = rojo claro-->
<path class="l" d="M8.51 518.16H59.5v24.34H8.51z"/>
<path class="${terceroIzquierda[0]}" d="M8.5 542.5h66v33h-66z"/>
<path class="${terceroIzquierda[1]}" d="M8.5 551.5h66v17h-66z"/>
<path class="l" d="M8.51 704.16H59.5v24.34H8.51z"/>
<path class="${cuartoIzquierda[0]}" d="M8.5 728.5h66v33h-66z"/>
<path class="${cuartoIzquierda[1]}" d="M8.5 737.5h66v17h-66z"/>
<path class="k" d="M845.5 142.5h56v63h-56z"/>
<path class="${primeroDerecha[0]}" d="M794.5 169.5h108v33h-108z"/>
<path class="${primeroDerecha[1]}" d="M794.5 178.5h108v17h-108z"/>
...
<path class="${terceroDerecha[0]}" d="M791.5 541.5h110v33h-110z"/> <!--Q = amarillo oscuro-->
<path class="${terceroDerecha[1]}" d="M791.5 550.5h110v17h-110z"/> <!--R = amarillo claro-->
<path class="${segundoDerecha[0]}" d="M791.5 357.5h111v33h-111z"/>
<path class="${segundoDerecha[1]}" d="M791.5 366.5h111v17h-111z"/>
<path class="${cuartoDerecha[0]}" d="M793.5 726.5h108v33h-108z"/> <!--S = ROSA OSCURO-->
<path class="${cuartoDerecha[1]}" d="M793.5 735.5h108v17h-108z"/> <!--T = ROSA CLARO-->
<path class="${primeroIzquierda[0]}" d="M8.5 167.5h66v33h-66z"/> <!--m = azul oscuro-->
<path class="${primeroIzquierda[1]}" d="M8.5 176.5h66v17h-66z"/> <!--n = azul claro-->
...
<!-- DRAG LINES -->
<line x1="70" y1="185" x2="70" y2="185" class="line line-back line-${cableNumeroIzquierda[0]}" />
<line x1="70" y1="185" x2="70" y2="185" class="line line-${cableNumeroIzquierda[0]}" />
<line x1="65" y1="375" x2="65" y2="375" class="line line-back line-${cableNumeroIzquierda[1]}" />
<line x1="65" y1="375" x2="65" y2="375" class="line line-${cableNumeroIzquierda[1]}" />
<line x1="65" y1="560" x2="65" y2="560" class="line line-back line-${cableNumeroIzquierda[2]}" />
<line x1="65" y1="560" x2="65" y2="560" class="line line-${cableNumeroIzquierda[2]}" />
<line x1="65" y1="745" x2="65" y2="745" class="line line-back line-${cableNumeroIzquierda[3]}" />
<line x1="65" y1="745" x2="65" y2="745" class="line line-${cableNumeroIzquierda[3]}" />
<!-- DRAG LINES -->`
console.log(cableNumeroIzquierda)

new Draggable('.drag-1', { 
  onDrag: function () { updateLine('.line-'+cableNumeroIzquierda[0], this.x + 120, this.y + 185); },
  onRelease: function () {
    if (this.x !== 670 || this.y !== primerDragCorrecto[0]) {
      reset('.drag-1', '.line-'+cableNumeroIzquierda[0], 70, 185);
      
    } else if (this.x === 670 && this.y === primerDragCorrecto[0]) toggleLight(primerDragCorrecto[1], true)
  },
  liveSnap: {points: [{x: 670, y: primerDragCorrecto[0]}],radius: 20}
});
new Draggable('.drag-2', {
  onDrag: function () { updateLine('.line-'+cableNumeroIzquierda[1], this.x + 120, this.y + 375); },
  onRelease: function () {
    if (this.x !== 670 || this.y !== segundoDragCorrecto[0] ) {
      console.log("no")
      reset('.drag-2', '.line-'+cableNumeroIzquierda[1], 70, 375);
      
    } else if (this.x === 670 && this.y === segundoDragCorrecto[0]) toggleLight(segundoDragCorrecto[1], true);console.log("Segundo :"+segundoDragCorrecto[1])
  },
  liveSnap: {points: [{x: 670, y: segundoDragCorrecto[0]}],radius: 20}
});
new Draggable('.drag-3', {
  onDrag: function () { updateLine('.line-'+cableNumeroIzquierda[2], this.x + 120, this.y + 560); },
  onRelease: function () {
    if (this.x !== 670 || this.y !== terceroDragCorrecto[0] ) {
      reset('.drag-3', '.line-'+cableNumeroIzquierda[2], 60, 560);
      
    } else if (this.x === 670 && this.y === terceroDragCorrecto[0]){ toggleLight(terceroDragCorrecto[1], true);console.log("Tercero : "+terceroDragCorrecto[1]);}
  },
  liveSnap: {points: [{x: 670, y: terceroDragCorrecto[0]}],radius: 20}
});
new Draggable('.drag-4', {
  onDrag: function () { updateLine('.line-'+cableNumeroIzquierda[3], this.x + 120, this.y + 745); },
  onRelease: function () {
    if (this.x !== 670 || this.y !== cuartoDragCorrecto[0] ) {
      reset('.drag-4', '.line-'+cableNumeroIzquierda[3], 60, 745);
      
    } else if (this.x === 670 && this.y === cuartoDragCorrecto[0]) toggleLight(cuartoDragCorrecto[1], true);console.log("Cuatro : "+cuartoDragCorrecto[1])
  },
  
  liveSnap: {points: [{x: 670, y: cuartoDragCorrecto[0]}],radius: 20}
});

function dragCorrecto(posicionIzquierda,cableIzquierda, cablesDerecha){
  posicionCorrecta = 0
  
  if(cableIzquierda === cablesDerecha[0]){
    posicionCorrecta = 1
  }
  else if(cableIzquierda === cablesDerecha[1]){
    posicionCorrecta = 2
  }
  else if(cableIzquierda === cablesDerecha[2]){
    posicionCorrecta = 3
  }
  else if(cableIzquierda === cablesDerecha[3]){
    posicionCorrecta = 4  
  }
  y = (posicionCorrecta- posicionIzquierda) * 188
  
  return [y,posicionCorrecta]
}

function revesCables(resultado){
  cableNumero = [];
...
function randomCables(){
  resultado = [];
  cables = [];
  while(resultado.length != 4){
    random = randomIntFromInterval(1,4);
    if(!resultado.includes(random))
      resultado.push(random)
  }
