        ...
        mp.events.add({
            ...
            'render': () => {
                ...
                if (this.player.getVariable('injured') == true && this.showInjured && !this.player.getVariable('adminJailed')) {
                    ...
                    mp.game.graphics.drawText(`Te desangraras en  ~HUD_COLOUR_ORANGE~${this.time}~w~ segundos.\n ${mp.players.local.getVariable('lastWepToHit') ? `Razon: ${mp.players.local.getVariable('lastWepToHit')}` : ``}`, [0.5, 0.85], {
                        font: 4,
                        color: [255, 255, 255, 255],
                        scale: [0.42, 0.42],
                        outline: true
