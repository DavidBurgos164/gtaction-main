...
class vehicleSystems {
    ...
    unlockVeh(player, vehicle) {
      ...
      player.adminDuty ? player.call('notifCreate', ['~r~Vehiculo abierto']) :player.call('ameCreate', ['Abre el vehiculo.']);
    ...
    lockVeh(player, vehicle) {
      ...
      player.adminDuty ? player.call('notifCreate', ['~r~Vehiculo cerrado']) :player.call('ameCreate', ['Cierra el vehiculo.']);
      player.adminDuty ? '_' : player.setVariable('lockAnim:data', true);
      vehicle.locked = true;
